...
the image:
    ...
    cp \file{/boot/efi/efi/redhat/initrd-*.img} \
        \file{/var/lib/systemimager/images/oscarimage/boot/efi/EFI/redhat/}
    
    cp \file{/boot/efi/efi/redhat/elilo.conf} \
        \file{/var/lib/systemimager/images/oscarimage/boot/efi/EFI/redhat/}
...
architecture).
	...
	\file{/sbin/chkconfig} --level 345 tftp on 
...
\begin{verbatim}
("cp \EFI\redhat\elilo.efi \}", "cp \EFI\redhat\elilo.conf \") 
\end{verbatim}

and boot from there ("elilo.efi 2.4.21-15.EL").
