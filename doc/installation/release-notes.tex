...
\item Ganglia RPMS rebuilt for FC3 x86\_64
\item Manpath issues with C3 fixed
\item Bugs with Ganglia setup test fixed
...
\subsection{CentOS 4.2 and Scientific Linux 4.2 Notes}
