...
\item SIS currently does not fully support 2.6 kernel, the way we make it
  ...
  working \file{modprobe.conf} for your client node to the image directory 
  \file{/var\-/lib\-/systemimager\-/imagesoscarimage\-/etc/},
  then you also need to move the script 
  \file{/var\-/lib\-/systemimager\-/scripts\-/post-install\-/22all.\-generate\-\_modprobe\_script} 
